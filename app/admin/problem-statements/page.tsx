...
export default function AdminProblemStatementsPage() {
  ...
  const [generalDeadlineInput, setGeneralDeadlineInput] = useState('2026-03-27T18:00');
  ...
  const DEFAULT_DEADLINE_ISO = '2026-03-27T18:00:00';
  ...
  useEffect(() => {
    ...
    try {
      ...
      if (existing) {
        ...
        setGeneralDeadlineInput('2026-03-27T18:00');
      }
