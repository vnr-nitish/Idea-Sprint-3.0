...
export default function Home() {
  ...
  const faqs = [
    ...
    { q: "Will food be provided?", a: "Yes. Dinner will be provided on 27th March and lunch will be provided on 28th March. Breakfast on 28th March must be arranged by participants." },
  ...
  const importantInstructions = [
    ...
    "Participants may take a day break if they choose to. Teams are allowed to leave the venue at 8:00 PM on 27th March and return by 8:00 AM on 28th March to continue the hackathon.",
    "Breakfast will not be provided on the morning of 28th March. However, dinner on 27th March and lunch on 28th March will be provided to all participants.",
    "Submission of a No Objection Certificate (NOC) is mandatory for all participants.",
    "Problem statements will be revealed on the spot, i.e. 27th March at 04:30 PM, shortly after the hackathon begins.",
  ];
